<div class="modal fade" id="add_masuk">
            ...
            <form id="quickForm">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="tanggal_masuk_add">Tanggal Masuk</label>                        
                        <div class="input-group date" id="date_picker1" data-target-input="nearest">
                            <input type="text" class="form-control datetimepicker-input" name="tanggal_masuk_add" id="tanggal_masuk_add" data-target="#date_picker1"/>
                            <div class="input-group-append" data-target="#date_picker1" data-toggle="datetimepicker">
                                <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                            </div>
                            <div id="tanggal_masuk_add-error"></div>                            
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="button" class="btn btn-primary" id="store_data_masuk">Simpan</button>
                </div>            
            </form>
        </div>
        <!-- /.modal-content -->
