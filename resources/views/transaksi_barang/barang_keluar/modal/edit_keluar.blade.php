<div class="modal fade" id="edit_keluar">
        ...
        <div class="modal-content">
            ...
            <form id="quickForm">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group date" id="date_picker2" data-target-input="nearest">
                            <input type="text" class="form-control datetimepicker-input" name="tanggal_keluar_edit" id="tanggal_keluar_edit" data-target="#date_picker2"/>
                            <div class="input-group-append" data-target="#date_picker2" data-toggle="datetimepicker">
                                <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                            </div>
                            <div id="tanggal_keluar_edit-error"></div>                            
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="button" class="btn btn-primary" id="update_data_keluar">Ubah</button>
                </div>            
            </form>
        </div>
        <!-- /.modal-content -->
